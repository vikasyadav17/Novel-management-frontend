      ...
      content = (
        ...
        >
          ...
          >
            ...
            >
              Total Novels:{" "}
              <span style={{ fontWeight: "bold" }}>{novels.length}</span>
            </div>
          </div>
          ...
          >
            <colgroup>
              <col title="ID" style={{ width: "5%" }} />
              <col title="Title" style={{ width: "30%" }} />
              <col title="Link" style={{ width: "25%" }} />
              <col title="Genre" style={{ width: "15%" }} />
              <col title="Status" style={{ width: "15%" }} />
              <col title="Total Chapters" style={{ width: "10%" }} />
              {/* Removed Rating and Worth to Continue columns */}
            </colgroup>
            <thead>
              <tr>
                <th
                ...
                {/* Removed Rating and Worth to Continue header cells */}
              </tr>
            </thead>
            <tbody>
              {paginatedNovels.map((novel) => {
                ...
                return (
                  <tr key={id} style={{ minHeight: "48px" }}>
                    ...
                    {/* Removed Rating and Worth to Continue data cells */}
                  </tr>
                );
              })}
            </tbody>
          ...
          {/* Replace pagination controls with modern SVG icons */}
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            >
              {currentPage} of {Math.ceil(novels.length / novelsPerPage)}
            </span>
            ...
            <button
              ...
              disabled={currentPage >= Math.ceil(novels.length / novelsPerPage)}
              style={{
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
